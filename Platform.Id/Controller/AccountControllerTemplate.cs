...
//using Platform.Id.Attributes;
//using Platform.Id.Model;
//using Platform.Id.ViewModels;

//namespace Platform.Id.Controllers
//{
//    [Authorize]
...
//            if (ModelState.IsValid)
//            {
//                var resultEmail = await UserManager.FindByEmailAsync(model.Email);
...
//                return View("ExternalLoginConfirmation", new ExternalLoginConfirmationVM { UserName = loginInfo.DefaultUserName });
//            }
//        }
