...
namespace Platform.Id
{
        ...
        where TUser : IdentityUser
    {
        ...
        private UserRolesRepository userRolesTable;
        private UserClaimsRepository userClaimsTable;
        private UserLoginsRepository userLoginsTable;
        ...
        public UserStore(MySQLDatabase database)
        {
            ...
            userRolesTable = new UserRolesRepository(database);
            userClaimsTable = new UserClaimsRepository(database);
            userLoginsTable = new UserLoginsRepository(database);
        }
